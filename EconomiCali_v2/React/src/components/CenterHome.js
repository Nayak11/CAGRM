  ...
  <option value="Sports">Sports</option>
          ...
          <div style={{float:"left",overflow:"hidden",width:"30%"}}>
           ...
           <input type="text" placeholder="Search" value={this.state.searchTerm} onChange={(event)=>{
             ...
             <br/>
           <button className="btn btn-default" style={{backgroundColor:"blue",width:"100px",height:"30px",color:"white"}} onClick={()=>{this.handleSearch(this.state.searchTerm)}} type="submit">Search  <i className="glyphicon glyphicon-search"></i></button>
